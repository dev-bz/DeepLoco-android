...
#endif
  double update_step = 0.00166667; // time_elapsed / mNumUpdateSteps;
  int num_update_steps = (time_elapsed == 0) ? 1: (time_elapsed/update_step); // mNumUpdateSteps;
